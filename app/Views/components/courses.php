    ...
    <div class="w-full">
          ...
          <div class="p-4">
            ...
            <div class="mt-3 flex items-center">
              <span class="text-sm font-semibold">only</span>&nbsp;<span class="font-bold text-xl">5,000</span>&nbsp;<span class="text-sm font-semibold">Rs</span>
            </div>
            <div class="mt-3 flex items-center">
  ...
  <div class="p-4">
    <div class="w-full">
          ...
          <div class="p-4">
            ...
            <p class="text-sm">The English language is so elastic that you can find another word to say the same thing.</p>
            <div class="mt-3 flex items-center">
              <span class="text-sm font-semibold">only</span>&nbsp;<span class="font-bold text-xl">5,000</span>&nbsp;<span class="text-sm font-semibold">Rs</span>
            </div>
            <div class="mt-3 flex items-center">
  ...
  <div class="p-4">
    <div class="w-full">
          ...
          <div class="p-4">
            ...
            <p class="text-sm">Reason, observation, and experience; the holy trinity of science.</p>
            <div class="mt-3 flex items-center">
              <span class="text-sm font-semibold">only</span>&nbsp;<span class="font-bold text-xl">5,000</span>&nbsp;<span class="text-sm font-semibold">Rs</span>
            </div>
            <div class="mt-3 flex items-center">
