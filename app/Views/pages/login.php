      ...
      <div class="flex items-center justify-center w-full lg:p-12">
        <div class="flex items-center xl:p-10">
          <form id="signin-form" class="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl" method="post" action="signin">
            ...
            <div><p><?= $error ?></p></div>
            <input id="email" type="email" placeholder="abc@gmail.com" class="flex items-center w-full px-5 py-4 mr-2 text-sm font-medium outline-none focus:bg-grey-400 mb-7 placeholder:text-grey-700 bg-grey-200 text-dark-grey-900 rounded-2xl" name="email"/>
